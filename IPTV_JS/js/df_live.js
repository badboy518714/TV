...
const Agent = [IOS_UA, IOS_UA, PC_UA]
...
async function home(filter) {
    const classes = [{ type_id: "qilu", type_name: '齐鲁' },{ type_id: "jinan", type_name: '济南' },{ type_id: "qingdao", type_name: '青岛' },{ type_id: "12", type_name: '582' }];
    const filterObj = {};
...
async function play(flag, id, flags) {
    ...
    if (index_1 === 2) { headers[ "Range"] = "bytes=0-190"; headers[ "range"] = "bytes=0-190";}
    return JSON.stringify({
        parse: 0,
        url: playUrl,
        header: headers,
